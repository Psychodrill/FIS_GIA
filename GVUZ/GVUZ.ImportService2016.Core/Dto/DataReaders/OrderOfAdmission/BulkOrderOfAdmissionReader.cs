...
{
    public class BulkOrderOfAdmissionReader : BulkReaderBase<PackageDataOrdersOrderOfAdmission>
    {
        //public BulkOrderOfAdmissionReader(PackageData packageData)
        public BulkOrderOfAdmissionReader(PackageData packageData) //, PackageDataOrdersOrderOfAdmission singleOrder)
        {
            //if (singleOrder != null)
            //    _records = new List<PackageDataOrdersOrderOfAdmission>() { singleOrder };
            //else
            _records = packageData.OrderOfAdmissionsToImport();
            ...
            AddGetter("Course", dto => 1); // OrderOfAdmissionType

...
@if exist "%ProgramFiles%\Microsoft SDKs\TypeScript" set PATH=%ProgramFiles%\Microsoft SDKs\TypeScript;%PATH%
@if exist "%ProgramFiles(x86)%\Microsoft SDKs\TypeScript" set PATH=%ProgramFiles(x86)%\Microsoft SDKs\TypeScript;%PATH%

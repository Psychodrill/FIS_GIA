<%--Отрисовка фильтра новых заявлений для data-bound модели (knockoutjs)--%>
<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<GVUZ.Web.ViewModels.ApplicationsList.NewApplicationsFilterViewModel>" %>
...
%>
<%--
   Контекст binding'a - свойство filter в javascript-модели NewApplicationsListViewModel
   тип filter - NewApplicationsFilterViewModel() (см. NewList.ascx)
--%>
        ...
        <table class="tableForm" >
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td  class="valueInside" style="white-space: nowrap">

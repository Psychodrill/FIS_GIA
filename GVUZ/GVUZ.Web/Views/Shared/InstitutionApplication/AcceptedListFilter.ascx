<%--Отрисовка фильтра принятых заявлений для data-bound модели (knockoutjs)--%>
<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<GVUZ.Web.ViewModels.ApplicationsList.AcceptedApplicationsFilterViewModel>" %>

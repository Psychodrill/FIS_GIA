...
namespace WebServices20.BindingExtenions
{
	...
	internal class MessageVersionConverter : TypeConverter
	{
		...
		public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
		{
			...
			throw new ArgumentOutOfRangeException("messageVersion", str,
			                                      "The argument must be of type System.ServiceModel.Channels.MessageVersion");
		}
		                                 ...
		                                 Type destinationType)
		{
			...
			{
				throw new ArgumentOutOfRangeException("messageVersion", value,
				                                      "The argument must be of type System.ServiceModel.Channels.MessageVersion");
			}
			return "None";
		}

/* Теперь смотрим на номера заявлений без учёта пробелов в начале/конце */
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO

ALTER PROC [dbo].[DeleteApplications_fromXml] @xml NTEXT, @institutionId INT, @userLogin VARCHAR(100)
AS
	SET NOCOUNT ON	

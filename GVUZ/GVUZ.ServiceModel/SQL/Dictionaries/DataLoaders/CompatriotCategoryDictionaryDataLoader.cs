...
namespace GVUZ.ServiceModel.SQL.Dictionaries.DataLoaders
{
    ...
    /// </summary>
    public class CompatriotCategoryDictionaryDataLoader : DictionaryItemDtoDataLoader
    {
        private const string Query = @"SELECT [CompatriotCategoryID], [Name] FROM [CompatriotCategory] ORDER BY 1";

...
{
    public class ApplicationBulkEntityCollector : BulkEntityCollectorBase<ApplicationDto, ApplicationBulkEntity>
    {
        public ApplicationBulkEntityCollector(IEnumerable<ApplicationDto> collection, int packageId, int institutionId) :
            base(collection, packageId, institutionId) { }

        public override IEnumerable<IBulkEntity> Collect()
        {
            return _collection.ToBulkEntity<ApplicationBulkEntity>(_packageId, _institutionId).Distinct();
        }
    }
}

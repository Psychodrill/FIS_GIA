...
namespace GVUZ.ServiceModel.Import.Helpers
{
    public static class ApplicationImportOrderHelperExtensions
    {
        public static void SetImportCompetitiveGroupTarget(this Application app)
        {

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BatchCheckFileFormat.aspx.cs" 
    Inherits="Esrp.Web.AllUsers.BatchCheckFileFormat"
        ...
        <table class="form f600">
            <tr><td>
                ...
                <div class="txt-in">
                    <p>
                        <b>Пример файла:</b> 
                        (<a href="/Shared/BatchBaseFileSample.csv" 
                    ...
                    <p>
                        <b>Формат файла:</b><br />
                        <pre>
                        &lt;Регистрационный номер свидетельства&gt;%&lt;Фамилия&gt;%&lt;Имя&gt;%&lt;Отчество&gt;%&lt;Русский язык&gt;%&lt;Математика&gt;%&lt;Физика&gt;%&lt;Химия&gt;%&lt;Биология&gt;%&lt;История России&gt;%&lt;География&gt;%&lt;Английский язык&gt;%&lt;Немецкий язык&gt;%&lt;Французский язык&gt;%&lt;Обществознание&gt;%&lt;Литература&gt;%&lt;Испанский язык&gt;%&lt;Информатика&gt;
                        </pre>
                    </p>
                    <p>

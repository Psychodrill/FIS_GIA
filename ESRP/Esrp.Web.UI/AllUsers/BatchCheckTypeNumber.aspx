<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BatchCheckTypeNumber.aspx.cs" 
    Inherits="Esrp.Web.Certificates.CommonNationalCertificates.BatchCheckTypeNumber"
        ...
        <table class="form f600">
            <tr><td>
                ...
                <div class="txt-in">
                    ...
                    <nobr>Обязательными для заполнения являются параметры «Типографский номер», «Фамилия». </nobr>
                    </p>

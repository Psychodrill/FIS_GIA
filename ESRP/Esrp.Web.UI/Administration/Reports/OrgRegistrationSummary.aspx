<%@ Page Language="C#" AutoEventWireup="True" CodeBehind="OrgRegistrationSummary.aspx.cs" Inherits="Esrp.Web.Administration.Reports.OrgRegistrationSummary" 
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <asp:ScriptManager ID="AjaxScriptManager" AsyncPostBackTimeout="0" runat="server" />
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="800px" 
            ...
            ShowFindControls="False" ShowPageNavigationControls="False" ShowBackButton="False">
        </rsweb:ReportViewer>
    </form>
</asp:Content>

...
{
    public partial class OrgRegistrationShort : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!this.IsPostBack)
            {
                ...
                this.ReportViewer1.ServerReport.ReportPath = "/" + ConfigurationManager.AppSettings["OrgRegistrationShortReportName"];

<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Templates/Administration.Master"
    AutoEventWireup="true" CodeBehind="OrgList.aspx.cs" Inherits="Esrp.Web.Administration.Organizations.OrgList" %>
            ...
            <div class="block">
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="UserCount" id="UserCount" class="_change_select_page_size" style="width: 320px!important;">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="ActivatedUsers" id="ActivatedUsers" class="_change_select_page_size" style="width: 320px!important;"  >
...
<asp:Content ID="Content4" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <div class="main_table">
        <div class="sort table_header">
            <div class="f_left">
                <a href="/Administration/Organizations/Administrators/OrgCard_Edit.aspx?OrgID=0"
                    class="create_user">Создать новую организацию</a>
            </div>
            <div class="sorted">
        ...
        <asp:DataGrid runat="server" ID="dgOrgList" AutoGenerateColumns="false" EnableViewState="false"
            ...
            <Columns>
                ...
                <asp:TemplateColumn>
                    <HeaderTemplate>
                        <div>
                            <esrp:SortRef_Prefix runat="server" SortExpr="UserCount" SortExprText="Пользователей"
                ...
                <asp:TemplateColumn>
                    ...
                    <HeaderTemplate>
                        <div>
                            <esrp:SortRef_Prefix runat="server" SortExpr="ActivatedUsers" SortExprText="Активированных&nbsp;пользователей"
                                Prefix="../../../Common/Images/" />
                        </div>
                    </HeaderTemplate>
                    <ItemTemplate>

<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Templates/Main.Master"
    AutoEventWireup="true" CodeBehind="StatisticSubordinateOrg.aspx.cs" Inherits="Esrp.Web.Administration.Organizations.UserDepartments.StatisticSubordinateOrg" %>
        ...
        <asp:DataGrid runat="server" ID="dgStatSubordinateOrg" AutoGenerateColumns="false"
            ...
            <Columns>
                ...
                <asp:TemplateColumn>
                    <HeaderStyle Width="5%" />
                    <HeaderTemplate>
                        <esrp:SortRef_Prefix ID="SortRef_Prefix2" runat="server" SortExpr="RegionName" SortExprText="Регион"
                            Prefix="../../../Common/Images/" />
                    </HeaderTemplate>
                    <ItemTemplate>
                        <div>
                ...
                <asp:TemplateColumn>
                    ...
                    <HeaderTemplate>
                        <esrp:SortRef_Prefix ID="SortRef_Prefix3" runat="server" SortExpr="AccreditationSertificate"
                ...
                <asp:TemplateColumn>
                    <HeaderStyle Width="20%" />
                    <HeaderTemplate>
                        <esrp:SortRef_Prefix ID="SortRef_Prefix5" runat="server" SortExpr="DirectorFullName"
                ...
                <asp:TemplateColumn>
                    ...
                    <HeaderTemplate>
                        <div>
                            <esrp:SortRef_Prefix ID="SortRef_Prefix4" runat="server" SortExpr="CountUser" SortExprText="<nobr>Польз-ей</nobr>"
                                Prefix="../../../Common/Images/" />
                        </div>
                    </HeaderTemplate>
                    <ItemTemplate>
                ...
                <asp:TemplateColumn>
                    ...
                    <HeaderTemplate>
                        <div>
                            <esrp:SortRef_Prefix ID="SortRef_Prefix6" runat="server" SortExpr="UserUpdateDate"

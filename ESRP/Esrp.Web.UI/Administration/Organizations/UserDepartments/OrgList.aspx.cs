namespace Esrp.Web.Administration.Organizations.UserDepartments
{
    ...
    public partial class OrgList : Page
    {
        ...
        public int GetOrzanizationUser()
        {
            ...
            int tryParse;
            if (!int.TryParse(orgId, out tryParse))
            {
                return -1;
            }
        ...
        protected override void OnInit(EventArgs e)
        {
            this.m_SqlConstructorGetOrganizations =
                new SqlConstructor_GetOrganizations_Department(this.Request.QueryString, this.GetOrzanizationUser());
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (this.Request.QueryString["RegID"] == null)
            {
                var url = string.Format(
                    "{0}{1}",
                    "/Administration/Organizations/UserDepartments/OrgList.aspx?",
                    "RegID=");
 ...
 public string FilterStatusString()
        ...
        private DataTable GetOrgs()
        {
            ...
            using (var connection = new SqlConnection(connectionString))
            {
                ...
                cmd.CommandText = cmd.CommandText;//.Replace("and OReq.Id = 4596", " ");
                cmd.Connection = connection;
                connection.Open();

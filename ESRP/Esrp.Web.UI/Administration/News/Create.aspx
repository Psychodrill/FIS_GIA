<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="Esrp.Web.Administration.News.Create"
                ...
                <div class="statement_table">
                    <table width="100%">
                        ...
                        <tr>
                            ...
                            <td width="1">
                                <asp:DropDownList ID="ddlIsActive" runat="server" Width="25px">

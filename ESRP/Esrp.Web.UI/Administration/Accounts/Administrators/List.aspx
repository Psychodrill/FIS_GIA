<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" 
    Inherits="Esrp.Web.Administration.Accounts.Administrators.List"
    ...
    <div class="border-block">
        ...
        <div class="content">
            <% if (User.IsInRole("EditAdministratorAccount"))
               { %>
                <ul>
                <li><a href="/Administration/Accounts/Administrators/Create.aspx" 
...
<asp:Content runat="server" ContentPlaceHolderID="cphContent">
    ...
    <asp:DataGrid runat="server" id="dgAdministratorList"
        ...
        <Columns>
            ...
            <ItemTemplate>
                <a href="/Administration/Accounts/Administrators/<%# 
                    (User.IsInRole("EditAdministratorAccount") ? "Edit.aspx" : "View.aspx") %>?login=<%# 

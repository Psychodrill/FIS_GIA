<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountKeyEdit.aspx.cs" 
    Inherits="Esrp.Web.Administration.Accounts.Administrators.AccountKeyEdit"
    ...
    <table class="form" style="width:auto">
        <tr>
            ...
            <td>
                ...
                <img src="/Common/Images/ico-datepicker-Esrp.gif" id="btnDateFrom" alt="выбрать дату"
        ...
        <tr>
            ...
            <td>
                ...
                <img src="/Common/Images/ico-datepicker-Esrp.gif" id="btnDateTo" alt="выбрать дату"
        ...
        <tr>
		    ...
		    <asp:Button runat="server" ID="btnSave" Text="Сохранить" CssClass="bt" onclick="btnSave_Click" />
		    </td>
        </tr>   
    </table>  

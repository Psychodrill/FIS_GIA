<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Create.aspx.cs" 
    Inherits="Esrp.Web.Administration.Accounts.Administrators.Create" 
...
<form runat="server">
    ...
    <table class="form" style="width:100%;">
        ...
        <asp:CustomValidator runat="server" ID="vldLogin" EnableClientScript="false"
            ControlToValidate="txtLogin" Display="None" OnServerValidate="vldLogin_ServerValidate"

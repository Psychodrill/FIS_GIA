<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HistoryVersion.aspx.cs"
    Inherits="Esrp.Web.Administration.Accounts.Auditors.HistoryVersion" 
...
<asp:Content runat="server" ContentPlaceHolderID="cphActions">
    ...
    <div class="border-block">
        ...
        <div class="content">
        <ul>
        <li><a href="/Administration/Accounts/Auditors/Edit.aspx?Login=<%= Request.QueryString["login"] %>"
...
<asp:Content runat="server" ContentPlaceHolderID="cphContent">
    ...
    <asp:SqlDataSource runat="server" ID="dsHistoryVersion" ConnectionString="<%$ ConnectionStrings:Esrp.Core.Properties.Settings.EsrpConnectionString %>"
        SelectCommand="GetAccountLog" CancelSelectOnNullParameter="false" SelectCommandType="StoredProcedure">
        <SelectParameters>

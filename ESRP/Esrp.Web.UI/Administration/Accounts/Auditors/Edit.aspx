<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" 
    Inherits="Esrp.Web.Administration.Accounts.Auditors.Edit"
...
<asp:Content runat="server" ContentPlaceHolderID="cphActions">
    ...
    <div class="border-block">
        ...
        <div class="content">
            <ul>
            <li><a href="/Administration/Accounts/Auditors/ChangePassword.aspx?Login=<%= Login %>"
                title="Изменить пароль">Изменить пароль</a></li>
            </ul>
            <div class="split"></div>
            <ul>
            <li><a href="/Administration/Accounts/Auditors/History.aspx?Login=<%= Login %>" 
                title="История изменений" class="gray">История изменений</a></li>
            <li><a href="/Administration/Accounts/Auditors/AuthenticationHistory.aspx?Login=<%= Login %>" 

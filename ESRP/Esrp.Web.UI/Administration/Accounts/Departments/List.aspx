<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" 
    Inherits="Esrp.Web.Administration.Accounts.Departments.List" 
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="cphActions">
    ...
    <div class="border-block">
        ...
        <div class="content">
        <ul>
        <li><a href="/Administration/Accounts/Users/Create.aspx" 
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="cphContent">
    ...
    <esrp:Pager_Simple runat="server" id="tablePager_top"></esrp:Pager_Simple>
    <asp:DataGrid runat="server" id="dgUserList"
        ...
        <Columns>
            ...
            <HeaderTemplate>
                <div><esrp:SortRef_prefix ID="SortRef_prefix1" Prefix="../../../Common/Images/" runat="server" SortExpr="login" SortExprText="Логин" /></div>
            </HeaderTemplate>
            <ItemTemplate>
            ...
            <HeaderTemplate>
                <esrp:SortRef_prefix ID="SortRef_prefix2" Prefix="../../../Common/Images/" runat="server" SortExpr="organizationName" SortExprText="Организация" />
            </HeaderTemplate>
            <ItemTemplate>
            ...
            <HeaderTemplate>
                <esrp:SortRef_prefix ID="SortRef_prefix3" Prefix="../../../Common/Images/" runat="server" SortExpr="lastName" SortExprText="Ответственное&nbsp;лицо" />
            </HeaderTemplate>
            <ItemTemplate>
            ...
            <HeaderStyle Width="15%"/>
            <HeaderTemplate>
                <div><esrp:SortRef_prefix ID="SortRef_prefix4" Prefix="../../../Common/Images/" runat="server" SortExpr="status" SortExprText="Статус" /></div>
            </HeaderTemplate>
            <ItemTemplate>
            ...
            <HeaderStyle Width="5%"/>
            <HeaderTemplate>
                <div><esrp:SortRef_prefix ID="SortRef_prefix5" Prefix="../../../Common/Images/" runat="server" SortExpr="operatorName" SortExprText="Оператор" /></div>
            </HeaderTemplate>
            <ItemTemplate>
                <%#Eval("OperatorName")%>
            </ItemTemplate>
            ...
            <HeaderTemplate>
                <div><esrp:SortRef_prefix ID="SortRef_prefix1" Prefix="../../../Common/Images/" runat="server" SortExpr="hasComments" SortExprText="Комментарии" /></div>
            </HeaderTemplate>
            <ItemTemplate>
    ...
    <esrp:Pager_Simple runat="server" id="tablePager_bottom"></esrp:Pager_Simple>
</asp:Content>
        ...
        if (!string.IsNullOrEmpty(Request.QueryString["eitype"]) && int.TryParse(Request.QueryString["eitype"], out eitype))
        {
            if (eitype == 0)
                ...
                filter.Add(string.Format("Тип ОУ “{0}”",
                    Esrp.Core.CatalogElements.OrgTypeDataAccessor.GetName(eitype)));
        }

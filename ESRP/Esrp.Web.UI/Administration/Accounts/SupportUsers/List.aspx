<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" 
    Inherits="Esrp.Web.Administration.Accounts.Support.List"
...
<asp:Content runat="server" ContentPlaceHolderID="cphActions">
    ...
    <div class="border-block">
        ...
        <div class="content">
            <% if (User.IsInRole("EditSupportAccount")) { %>
                <ul>
                <li><a href="/Administration/Accounts/SupportUsers/Create.aspx"
...
<asp:Content runat="server" ContentPlaceHolderID="cphContent">
    ...
    <asp:DataGrid runat="server" id="dgSupportList"
        ...
        <Columns>
            ...
            <ItemTemplate>
                <a href="/Administration/Accounts/SupportUsers/<%# 
                    (User.IsInRole("EditSupportAccount") ? "Edit.aspx" : "View.aspx") %>?login=<%# 

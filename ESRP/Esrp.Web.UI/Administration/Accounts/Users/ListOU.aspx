<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ListOU.aspx.cs" Inherits="Esrp.Web.Administration.Accounts.Users.ListOU"
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="cphContent">
    <div class="main_table">
        <div class="sort table_header">
            <div class="f_left">
                <% if (User.IsInRole("EditUserOUAccount"))
                   { %>
                <a href="/Administration/Accounts/Users/CreateOU.aspx" class="create_user">Создать пользователя</a>
                <% } %>
            </div>
            <div class="sorted">
                ...
                <p class="page_nav">
                    <web:DataSourcePager ID="DataSourcePager4" runat="server" DataSourceId="DataSourcePagerHead"
        ...
        <asp:DataGrid runat="server" ID="dgAdministratorList" DataSourceID="dsAdministratorList"
            ...
            <Columns>
                <asp:TemplateColumn>
                    ...
                    (User.IsInRole("EditUserOUAccount") ? "EditOU.aspx" : "ViewOU.aspx") %>?login=<%# 
    ...
    <asp:SqlDataSource runat="server" ID="dsAdministratorList" ConnectionString="<%$ ConnectionStrings:Esrp.Core.Properties.Settings.EsrpConnectionString %>"
        SelectCommand="SearchAccountOU" CancelSelectOnNullParameter="false" SelectCommandType="StoredProcedure">
        <SelectParameters>

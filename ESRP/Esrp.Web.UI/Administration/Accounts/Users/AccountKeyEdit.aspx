<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountKeyEdit.aspx.cs"
    Inherits="Esrp.Web.Administration.Accounts.Users.AccountKeyEdit" MasterPageFile="~/Common/Templates/Administration.Master" %>
    ...
    <div class="left_col">
        ...
        <div class="col_in">
            <div class="statement edit">
                ...
                <div class="statement edit">
                    <p class="title">
                        Редактировать ключ доступа "<%= CurrentAccountKey.Key %>"</p>
                </div>

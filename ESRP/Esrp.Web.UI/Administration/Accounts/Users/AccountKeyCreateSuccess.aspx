<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountKeyCreateSuccess.aspx.cs" 
    Inherits="Esrp.Web.Administration.Accounts.Users.AccountKeyCreateSuccess" 
        ...
        EnableClientScript="false" HeaderText="<p>Произошли следующие ошибки:</p>" />
                    ...
                    <div class="col_in">
						<div class="statement edit">
							...
							<div class="clear"></div>
                            <div class="statement edit">
							    <p class="title">Ключ доступа “<%= AccountKeyCode %>” для пользователя “<%= Login %>” создан успешно.</p>
                            </div>

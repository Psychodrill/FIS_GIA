<%@ Page Language="C#" MasterPageFile="~/Common/Templates/Administration.Master"
    AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Esrp.Web.Administration.Deliveries.Edit"
    Title="Untitled Page" %>
        ...
        <div class="col_in">
            <div class="statement edit">
                ...
                <p class="statement_menu">
                    <a href="#" onclick="$('#<%= btnUpdate.ClientID %>').click();" class="active"><span>Сохранить</span></a>
                </p>
                <div class="clear">
                </div>
                    ...
                    <table width="700">
                        ...
                        <tr>
                            ...
                            <td nowrap>
                                ...
                                <asp:CustomValidator ID="CustomValidator1" runat="server" OnServerValidate="validateDate" ErrorMessage='Поле "Дата отправки" обязательно для заполнения' Display="None" />
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td nowrap>
                                <asp:CheckBoxList runat="server" DataTextField="Name" DataValueField="Id" ID="ChBRecipients"   CssClass="checkbox-box-list"/>

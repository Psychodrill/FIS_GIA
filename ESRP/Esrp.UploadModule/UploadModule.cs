...
namespace Esrp.UploadModule
{
    ...
    public class UploadModule : System.Web.IHttpModule
    {
        ...
        /// </summary>
        private long mBadFileSize = Esrp.UploadModule.Properties.Settings.Default.BadFileSize;
        /// <summary>
        /// Максимальный размер загружаемого файла
        /// </summary>
        private long mMaxFileSize = Esrp.UploadModule.Properties.Settings.Default.MaxFileSize;
        /// <summary>
        /// Список страниц для которых производится обработка запросов
        /// </summary>
        private string mPages = Esrp.UploadModule.Properties.Settings.Default.Pages;

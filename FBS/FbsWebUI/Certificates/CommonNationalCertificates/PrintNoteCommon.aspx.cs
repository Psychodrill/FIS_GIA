namespace Fbs.Web.Certificates.CommonNationalCertificates
{
    ...
    /// </summary>
    public partial class PrintNoteCommon : Page
    {
        ...
        private PrintNoteData LoadCertificateInfo(Guid key)
        {
            if (this.Session["CertificateInfo"] != null
                && this.Session["CertificateInfo"] is KeyValuePair<Guid, PrintNoteData>
                && ((KeyValuePair<Guid, PrintNoteData>)this.Session["CertificateInfo"]).Key == key)
            {
                return ((KeyValuePair<Guid, PrintNoteData>)this.Session["CertificateInfo"]).Value;
            }

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BatchRequestByTypographicNumberResult.aspx.cs" 
    Inherits="Fbs.Web.Certificates.CommonNationalCertificates.BatchRequestByTypographicNumberResult" 
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="cphCertificateActions">
    <div class="h10"></div>
    <div class="border-block">
        ...
        <ul>
            ...
            <a href="/Certificates/CommonNationalCertificates/BatchRequestByPassportResultExportCsvExtended.aspx?id=<%= Request.QueryString["id"] %>" 
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="cphCertificateContent">
<form runat="server" target="_blank" >
            ...
            <ItemTemplate>
             <asp:LinkButton ID="LinkButton1" title='<%# "Свидетельство № "+ Eval("CertificateNumber")+ " не найдено"%>' style="color:Red" Text="не найдено" runat="server" CommandName="PrintNotFound" Visible='<%#!Convert.ToBoolean(Eval("IsExist")) && Convert.ToBoolean(ConfigurationManager.AppSettings["EnableNotFoundNote"])%>' />
                        <asp:PlaceHolder ID="PlaceHolder1" Visible='<%# Convert.ToBoolean(Eval("IsExist")) || !Convert.ToBoolean(ConfigurationManager.AppSettings["EnableNotFoundNote"])%>' runat="server">
                            ...
                            <%# ShowCertificateNumber(Container.DataItem) %>
                        </asp:PlaceHolder>
            </ItemTemplate>
            </asp:TemplateColumn>
    ...
    <web:NoRecordsText ID="NoRecordsText1" runat="server" ControlId="dgResultsList">
    ...
    <script runat="server">
        ...
        private static string ShowCertificateNumber(object dataItem)
        {
            ...
            {
                //string notFoundLink = String.Format("PrintNotFoundNote.aspx?check=byTypographicName&GivenName={0}&FirstName={1}&LastName={2}&tNumber={3}", dataRow["PatronymicName"], dataRow["FirstName"], lastName, dataRow["TypographicNumber"]);
                return
                         string.Format(

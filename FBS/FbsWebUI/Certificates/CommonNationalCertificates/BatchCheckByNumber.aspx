<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BatchCheckByNumber.aspx.cs"
    Inherits="Fbs.Web.Certificates.CommonNationalCertificates.BatchCheckByNumber"
            ...
            <td>
                <div class="notice" id="BatchCheckSampleNotice">
                    ...
                    <div class="cont">
                        ...
                        <div class="txt-in">
                            <p>
                                <b>Пример файла:</b> (<a href="/Shared/BatchBaseFileByNumberSample.csv" title="скачать файл в формате csv">скачать
                                    файл</a>)
                                <pre>
<fbs:FileView ID="FileView1" runat="server" FilePath="/Shared/BatchBaseFileByNumberSample.csv" /></pre>
                            </p>
                            <p>
                                <b>Формат файла:</b><br />
                                <pre>
                        &lt;Регистрационный номер свидетельства&gt;%&lt;Русский язык&gt;%&lt;Математика&gt;%&lt;Физика&gt;%&lt;Химия&gt;%&lt;Биология&gt;%&lt;История России&gt;%&lt;География&gt;%&lt;Английский язык&gt;%&lt;Немецкий язык&gt;%&lt;Французский язык&gt;%&lt;Обществознание&gt;%&lt;Литература&gt;%&lt;Испанский язык&gt;%&lt;Информатика&gt;
                            ...
                            <p>
                                ...
                                запроса «Регистрационный номер свидетельства» и баллов по предметам, хранящимся
                                в Подсистеме ФИС &laquo;Результаты ЕГЭ&raquo;. Поля «Регистрационный номер свидетельства» и баллы по двум любым предметам
        ...
        <tr>
            <td>
                <asp:Label ID="FileErrorMsg1" Visible="true" runat="server" Text="" Font-Size="Smaller"
    ...
    <div id="ResultContainer" style="width: 100%; height: auto; margin-bottom: 10px;">
        ...
        <asp:DataGrid runat="server" ID="dgResultsList" OnPageIndexChanged="dgResultsList_PageIndexChanged"
            ...
            CssClass="table-th-border table-th" Visible="false">
    ...
    <asp:DataGrid runat="server" ID="dgUserList" DataSourceID="dsUserList" AutoGenerateColumns="false"
        EnableViewState="false" ShowHeader="True" GridLines="None" CssClass="table-th f600" OnItemDataBound="DataGridOnItemDataBound">
        <HeaderStyle CssClass="th" />
        <Columns>
            <asp:TemplateColumn>
    ...
    Convert.ToBoolean(this.Eval("IsProcess"))
        ...
        : string.Format("найдено {0} из {1}", this.Eval("Found"), this.Eval("Total")) %>
            ...
            <asp:TemplateColumn>
                ...
                <ItemTemplate>
                    <%#this.GetResult(Convert.ToBoolean(this.Eval("IsProcess")), this.Eval("Id")) %>
                </ItemTemplate>
            </asp:TemplateColumn>
            <%-- Удалить элемент--%>
            <asp:TemplateColumn>

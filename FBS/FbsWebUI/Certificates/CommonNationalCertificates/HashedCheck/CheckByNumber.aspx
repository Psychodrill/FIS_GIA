<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckByNumber.aspx.cs"
    Inherits="Fbs.Web.Certificates.CommonNationalCertificates.HashedCheck.CheckByNumber"
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphCertificateContent" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            ...
            <ContentTemplate>
                <table style="width: 100%;" class="form">
                    <tr runat="server" id="RowTyphNumber" visible="false">
                        <td style="width: 20%;">
                            Типографский номер
                        </td>
                        <td>
                            <asp:Label runat="server" ID="LTyphNumber" EnableViewState="false"></asp:Label>
                        </td>
                    </tr>
                </table>
            </ContentTemplate>
    ...
    function ValidateNumber()
    {
        ...
        if(number.charAt(2)!='-' || number.charAt(12)!='-')
        {
            return false;
        }
        for (var Index=0;Index<number.length;Index++)
        {
            if((Index!=2)&&(Index!=12)&&(!IsDigit(number.charAt(Index))))
            {
                return false;
            }
        }
    ...
    function ValidatePage()
    {
        ...
        {
            Errors +='<li>Не заполнено поле "Номер свидетельства"</li>';
        }
        else if(!ValidateNumber())
        {
            Errors +='<li>Поле "Номер свидетельства" должно быть в формате XX-XXXXXXXXX-XX</li>';
        }
    ...
    function ShowResults()
    {
        ...
        document.getElementById('SNumberOut').innerHTML=document.getElementById('TBNumber').value; 
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        ...
        <ContentTemplate>
            <div id="DWait" runat="server" style="display: none; text-align: center;">
                Осуществляется обработка запроса<br />

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BatchCheckByPassportNumberResult.aspx.cs"
    Inherits="Fbs.Web.Certificates.CommonNationalCertificates.BatchCheckByPassportNumberResult"
   ...
   <div class="notice" id="BatchCheckResultSubjectNotice">
    ...
    <div id="ResultContainer" style="width: 100%; height: auto;">
        <asp:DataGrid runat="server" ID="dgResultsList" DataSourceID="dsResultsList" AutoGenerateColumns="false"
            EnableViewState="false" ShowHeader="True" GridLines="None" CssClass="table-th-border table-th">

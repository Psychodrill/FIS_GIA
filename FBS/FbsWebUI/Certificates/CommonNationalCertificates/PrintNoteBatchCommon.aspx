<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintNoteBatchCommon.aspx.cs" Inherits="Fbs.Web.Certificates.CommonNationalCertificates.PrintNoteBatchCommon" EnableViewState="false" %>
...
<body>
    ...
    <asp:PlaceHolder ID="phNoteFound" runat="server">
...
<br><br><%= string.IsNullOrEmpty(OrganizationName) ? "<название не задано>" : OrganizationName %>
   ...
   <tr>
    ...
    <asp:PlaceHolder runat="server" ID="phNoteNotFound">
        <table cellpadding="5" cellspacing="0" border="0" style="width: 590px; font-family: Arial; font-size: .9em; text-align: center;">
                    <tbody>
                        <tr>
                            <td style="font-size: 1.2em; font-weight: bold;">

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BatchRequestByPassport.aspx.cs" 
         Inherits="Fbs.Web.Certificates.CommonNationalCertificates.BatchRequestByPassport" 
...
<asp:Content runat="server" ContentPlaceHolderID="cphCertificateContent">
    ...
    <form runat="server" enctype="multipart/form-data">
        ...
        <table class="form f600">
            <tr><td>
                    <div class="notice" id="BatchRequestByPassportSampleNotice">
                        ...
                        &lt;фамилия&gt;%&lt;имя&gt;%&lt;отчество&gt;%&lt;серия&nbsp;документа&gt;%&lt;номер&nbsp;документа&gt;
                                ...
                                <p>Поиск и проверка свидетельств осуществляются по строгому соответствию параметров запроса «Фамилия», «Имя», «Отчество», "Серия паспорта", "Номер паспорта" параметрам, хранящимся в Подсистеме ФИС &laquo;Результаты ЕГЭ&raquo;.
                                    Поля «Номер паспорта» и «Фамилия» обязательны для заполнения.</p>
                            </div>
                        </div>
            ...
            <asp:DataGrid runat="server" id="dgReportResultsList"
                ...
                <Columns>
                    ...
                    <asp:TemplateColumn>
                        ...
                        <ItemTemplate>
                            <%# this.HighlightValue(this.Eval("Серия паспорта"))%>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                    ...
                    <asp:TemplateColumn>
                        ...
                        <ItemTemplate>
                            <%# this.HighlightValue(this.Eval("Номер паспорта"))%>
                        </ItemTemplate>
                    </asp:TemplateColumn>
        ...
        <fbs:HistoryCheckCommon runat="server" ID="historyCheckCommon" CheckType="DocumentNumber" CheckMode="Batch" ShowDeleteHistoryLink="True" />
    </form>
</asp:Content>
...
<script runat="server" type="text/C#">
    ...
    private string GetResult(bool isProcess, object id, object year)
    {
        string enable =
            String.Format(
                "<a href=\"/Certificates/CommonNationalCertificates/BatchRequestByPassportResult.aspx?id={0}&year={1}\">результат</a>",
                id,
                year);

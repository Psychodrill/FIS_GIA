namespace Fbs.Web.Certificates.CommonNationalCertificates
{
    ...
    public partial class BatchRequestByPassportNew : BasePage, IHistoryNavigator
    {
        ...
        private const string FailedUri = "/Certificates/CommonNationalCertificates/BatchRequestByPassportNew.aspx";
        private const string SuccessUri = "/Certificates/CommonNationalCertificates/BatchRequestByPassportNewResultCommon.aspx?batchId={0}";
        ...
        {
            return "BatchRequestByPassportNewResultCommon.aspx";
        }
    }
}

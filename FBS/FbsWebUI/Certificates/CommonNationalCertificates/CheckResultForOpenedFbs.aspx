<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CheckResultForOpenedFbs.aspx.cs"
    Inherits="Fbs.Web.Certificates.CommonNationalCertificates.CheckResultForOpenedFbs"
    ...
    <asp:Repeater runat="server" ID="rpSearch" OnItemDataBound="rpSearch_ItemDataBound">
                        ...
                        <td> 
                            ...
                            <asp:HyperLink ID="lnkCheckHystory" Enabled='<%# !(Eval("UniqueIHEaFCheck") is DBNull) && Convert.ToInt32(Eval("UniqueIHEaFCheck")) > 0 %>'
                                NavigateUrl='<%# string.Format(
                                                    "~/Certificates/CommonNationalCertificates/CheckHistoryForOpenedFbs.aspx?certificateId={0}&certificateNumber={1} ", Eval("CertificateId"), Eval("Number")) %>'
        ...
        <Columns>
            <asp:TemplateColumn>
                ...
                <ItemTemplate>
                    <%#HighlightValue(Eval("SubjectName"),Convert.ToBoolean(Convert.ToInt32(Eval("SubjectMarkIsCorrect") is DBNull ? "0" : Eval("SubjectMarkIsCorrect"))) ||
                                            string.IsNullOrEmpty(Convert.ToString(Eval("CheckSubjectMark") is DBNull ? "" : Eval("CheckSubjectMark"))))%>
                </ItemTemplate>
            </asp:TemplateColumn>
            <asp:TemplateColumn>

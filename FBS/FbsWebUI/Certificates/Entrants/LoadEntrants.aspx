<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoadEntrants.aspx.cs" 
    Inherits="Fbs.Web.Certificates.Entrants.LoadEntrants" 
...
<form runat="server">
    ...
    <asp:ValidationSummary runat="server" DisplayMode="BulletList" EnableClientScript="false"
     ...
     <table class="form f600">
        <tr><td>
            <div class="notice" id="LoadEntrantsSampleNotice">
            ...
            <div class="txt-in">
                ...
                <p>Код направления и код специальности должны соответствовать классификатору, утвержденному Министерством образования РФ.</p>

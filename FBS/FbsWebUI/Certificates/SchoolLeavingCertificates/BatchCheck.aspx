<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BatchCheck.aspx.cs" 
    Inherits="Fbs.Web.Certificates.SchoolLeavingCertificates.BatchCheck" 
...
<asp:Content ContentPlaceHolderID="cphCertificateContent" runat="server">
    ...
    <form runat="server" enctype="multipart/form-data">
        ...
        <table class="form f600">
            <tr><td>
                <div class="notice" id="SchoolLeavingCertificateBatchCheckSampleNotice">
                ...
                <div class="txt-in">
                    <p>
                        <b>Пример файла:</b> 
                        (<a href="/Shared/SchoolLeavingCertificatesBatchCheckFileSample.txt" 
                            title="скачать файл в формате csv">скачать файл</a>)
                        <pre><fbs:FileView ID="FileView1" runat="server" 
                            FilePath="/Shared/SchoolLeavingCertificatesBatchCheckFileSample.txt" /></pre>
                    </p>
                    <p>
                        <b>Формат файла:</b><br />
                        <pre>
        ...
        <asp:SqlDataSource runat="server" ID="dsBatchList" 
            ...
            SelectCommand="dbo.SearchSchoolLeavingCertificateCheckBatch" CancelSelectOnNullParameter="false"
...
<script runat="server" type="text/C#">
    ...
    string GetResult(bool isProcess, object id)
    {
        string enable = String.Format(
                "<a href=\"/Certificates/SchoolLeavingCertificates/BatchCheckResult.aspx?id={0}\">результат</a>", id);

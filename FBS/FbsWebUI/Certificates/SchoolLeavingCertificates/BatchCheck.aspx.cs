...
namespace Fbs.Web.Certificates.SchoolLeavingCertificates
{
    ...
    {
        private const string SuccessUri = "/Certificates/SchoolLeavingCertificates/BatchCheckSuccess.aspx?id={0}";
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (Page.IsValid)
            {
                ...
                // Добавлю данные в бд
                long id = CommonNationalCertificateContext.UpdateSchoolLeavingCertificateCheckBatch(data, CurrentUser.ClietnLogin);
        ...
        {
            // Формт номера аттестата пока не известен

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BatchRequest.aspx.cs" 
    Inherits="Fbs.Web.Certificates.CompetitionCertificates.BatchRequest"
...
<asp:Content runat="server" ContentPlaceHolderID="cphCertificateContent">
    ...
    <form runat="server" enctype="multipart/form-data">
        ...
        <table class="form f600">
            <tr><td>
                ...
                <div class="txt-in">
                    <p>
                        <b>Пример файла:</b> 
                        (<a href="/Shared/CompetitionCertificatesBatchRequestFileSample.txt" 
                            title="скачать файл в формате csv">скачать файл</a>)
                        <pre><fbs:FileView runat="server" 
                            FilePath="/Shared/CompetitionCertificatesBatchRequestFileSample.txt" /></pre>
                    </p>
                    <p>
                        <b>Формат файла:</b><br />
                        <pre>
        ...
        <web:NoRecordsText runat="server" ControlId="dgBatchList">
            <div class="notfound w600">Не найдено ни одной записи</div>
        </web:NoRecordsText>
        ...
        <asp:SqlDataSource runat="server" ID="dsBatchList" 
            ...
            SelectCommand="dbo.SearchCompetitionCertificateRequestBatch" CancelSelectOnNullParameter="false"
...
<script runat="server" type="text/C#">
    ...
    string GetResult(bool isProcess, object id)
    {
        string enable = String.Format(
                "<a href=\"/Certificates/CompetitionCertificates/BatchRequestResult.aspx?id={0}\">результат</a>", id);

...
namespace Fbs.Web.AllUsers
{
    public partial class BatchCheckPassport : BasePage
    {
       ...
       // private const string SuccessUri = "/Certificates/CommonNationalCertificates/BatchCheckPassportResult.aspx";
        ...
        {
            get { return this.Session["ResultsListPbc"] as DataTable; }
            set { this.Session["ResultsListPbc"] = value; }
        }
        ...
        {
            // Получу ошибку
            HttpException checkException = this.Server.GetLastError() as HttpException;
        ...
        private bool Parse()
        {
            ...
            using (StreamReader reader = new StreamReader(batchStream, Encoding.GetEncoding(1251)))
            {
                    string line;
                    int lineIndex = 0;
                    string errorMessage;
            ...
            try
            {
                ...
                if (fuData.HasFile)
                {
                    ...
                    else
                    {
                        ...
                        this.Session[fileName] = ReportTable;

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BatchCheckFileFormatByPassport.aspx.cs"
    Inherits="Fbs.Web.AllUsers.BatchCheckFileFormatByPassport" MasterPageFile="~/Common/Templates/TestBatchCheck.Master" %>
                    ...
                    <div class="cont">
                        ...
                        <div class="txt-in">
                            <p>
                                ...
                                <pre>
<fbs:FileView runat="server" FilePath="/Shared/BatchCheckFileFormatByPassportSample.csv" /></pre>
                            </p>
                            <p>
                                <b>Формат файла:</b><br />
                                <pre>
&lt;Серия документа&gt;%&lt;Номер документа&gt;%&lt;Русский язык&gt;%&lt;Математика&gt;%&lt;Физика&gt;%&lt;Химия&gt;%&lt;Биология&gt;%&lt;История России&gt;%&lt;География&gt;%&lt;Английский язык&gt;%&lt;Немецкий язык&gt;%&lt;Французский язык&gt;%&lt;Обществознание&gt;%&lt;Литература&gt;%&lt;Испанский язык&gt;%&lt;Информатика&gt;
                            ...
                            <p>
                                <nobr>Обязательным для заполнения является поле «Номер документа»</nobr>
                            </p>
                        </div>
                    </div>
                    <div class="bottom">
                ...
                <p>
                    <asp:Label ID="Label1" runat="server" Font-Size="Smaller" Text="Допускаются файлы в кодировке Windows-1251"></asp:Label></p>
                <asp:FileUpload ID="fuData" runat="server" CssClass="content-in wlong" />
            </td>
        </tr>
        <tr>
            <td>
                <asp:Label ID="FileErrorMsg" Visible="false" runat="server" Text="" Font-Size="Smaller"
    ...
    <br />
    <p>
        <asp:Label ID="resultLbl" runat="server" Font-Size="Medium" Text="Результат" Visible="false"></asp:Label></p>
    </form>
</asp:Content>

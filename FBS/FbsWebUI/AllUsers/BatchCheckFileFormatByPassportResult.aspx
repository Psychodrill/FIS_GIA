<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BatchCheckFileFormatByPassportResult.aspx.cs"
    Inherits="Fbs.Web.AllUsers.BatchCheckFileFormatByPassportResult" MasterPageFile="~/Common/Templates/TestBatchCheck.Master" %>
...
<asp:Content ContentPlaceHolderID="cphCertificateContent" runat="server">
    <div class="notice" id="BatchCheckResultSubjectNotice">
        ...
        <div class="cont">
            ...
            <div class="txt-in">
                ...
                <p>
                    Коды ошибок: С- превышено максимальное кол-во строк; П - неверное число полей, поля должны разделяться символом "%'; СП
                    - поле Серия паспорта должно быть заполнено; НП - поле Номер паспорта должно быть
                    заполнено. БП - поля баллов должны содержать числовые значения от
                    0 до 100 (целые или дробные с одним десятичным знаком после запятой)
                </p>
                <p>
    ...
    <div id="ResultContainer" style="width: 100%; height: auto;">
                ...
                <td>
                    <web:DataSourcePager runat="server" ID="DataSourcePagerHead" DataSourceId="dsResultsListCount"
                        ...
                        <Header>
                            ...
                            <web:DataSourceMaxRowCount ID="DataSourceMaxRowCount1" runat="server" Variants="10,20,50,100"
        ...
        <asp:DataGrid runat="server" ID="dgResultsList" AutoGenerateColumns="false" EnableViewState="true"
            ShowHeader="True" GridLines="None" CssClass="table-th-border table-th" PagerStyle-Position="Top"
            PagerStyle-HorizontalAlign="Left" PagerStyle-Mode="NumericPages" PagerStyle-ForeColor="#0066FF">
            ...
            <tr>
                <td>
                    <web:DataSourcePager ID="DataSourcePager2" runat="server" DataSourceId="DataSourcePagerHead"
                        ...
                        <Header>
                            Результаты проверок #StartRowIndex#-#LastRowIndex# из #TotalCount#.
                            <web:DataSourceMaxRowCount ID="DataSourceMaxRowCount2" runat="server" Variants="10,20,50,100"
                                DataSourcePagerId="DataSourcePagerHead">
                                <Header>
                                    Записей на странице:
                                </Header>

<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Templates/Administration.Master" AutoEventWireup="true" CodeBehind="OrgChecksDetailed.aspx.cs" Inherits="Fbs.Web.Administration.Reports.OrgChecksDetailed" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphContent" runat="server">
    ...
    <rsweb:ReportViewer ID="ReportViewer1" runat="server" Width="800px" SizeToReportContent="True"
        ...
        ShowPageNavigationControls="False" ShowFindControls="False" ShowBackButton="False">
    </rsweb:ReportViewer>
    </form>
</asp:Content>

<%@ Page Language="C#" MasterPageFile="~/Common/Templates/Administration.Master"
    AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Fbs.Web.Administration.Deliveries.Edit"
    Title="Untitled Page" %>
...
<asp:Content ContentPlaceHolderID="cphContent" runat="server">
    ...
    <table class="form">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="TbDate"
            EnableClientScript="false" Display="None" ErrorMessage='Поле "Дата отправки" обязательно для заполнения' />

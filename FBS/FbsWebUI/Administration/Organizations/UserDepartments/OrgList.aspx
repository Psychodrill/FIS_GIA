<%@ Page Title="" Language="C#" MasterPageFile="~/Common/Templates/Administration.Master"
    AutoEventWireup="true" CodeBehind="OrgList.aspx.cs" Inherits="Fbs.Web.Administration.Organizations.UserDepartments.OrgList" %>
            ...
            <div class="content-f2">
                ...
                <table class="filtr2-table">
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="UserCount" id="UserCount" class="sel">
    ...
    <asp:DataGrid runat="server" ID="dgOrgList" AutoGenerateColumns="false" EnableViewState="false"
        ...
        <Columns>
            <asp:TemplateColumn>
                ...
                <HeaderTemplate>
                    <div>
                        <fbs:SortRef_Prefix ID="SortRef_Prefix1" runat="server" SortExpr="FullName" SortExprText="Название" Prefix="../../../Common/Images/" />
                    </div>
                </HeaderTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateColumn>
                <HeaderTemplate>
                    <fbs:SortRef_Prefix ID="SortRef_Prefix2" runat="server" SortExpr="TypeName" SortExprText="Тип" Prefix="../../../Common/Images/" />
                </HeaderTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateColumn>
                <HeaderTemplate>
                    <fbs:SortRef_Prefix ID="SortRef_Prefix3" runat="server" SortExpr="RegName" SortExprText="Регион" Prefix="../../../Common/Images/" />
                </HeaderTemplate>
                <ItemTemplate>
            ...
            <asp:TemplateColumn>
                <HeaderTemplate>
                    <div>
                        <fbs:SortRef_Prefix ID="SortRef_Prefix4" runat="server" SortExpr="UserCount" SortExprText="Пользователей"
            ...
            <asp:TemplateColumn>
                ...
                <HeaderTemplate>
                    <div>
                        <fbs:SortRef_Prefix ID="SortRef_Prefix5" runat="server" SortExpr="ActivatedUsers" SortExprText="Активированных&nbsp;пользователей" Prefix="../../../Common/Images/" />
                    </div>
                </HeaderTemplate>
                <ItemTemplate>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" 
    Inherits="Fbs.Web.Administration.Accounts.Administrators.List"
...
<asp:Content runat="server" ContentPlaceHolderID="cphContent">
    ...
    <tr><td>
        ...
        <web:DataSourcePager runat="server"
            ...
            DataSourceId="dsAdministratorListCount"
    ...
    <asp:DataGrid runat="server" id="dgAdministratorList"
        DataSourceID="dsAdministratorList"
        ...
        <Columns>
            ...
            <ItemTemplate>
                <a href="/Administration/Accounts/Administrators/View.aspx?login=<%# 
            ...
            <HeaderTemplate>
                <fbs:SortRef_prefix Prefix="../../../Common/Images/" runat="server" SortExpr="Name" SortExprText="Ф. И. О. пользователя" />
            </HeaderTemplate>
            <ItemTemplate>
            ...
            <HeaderTemplate>
                <div><fbs:SortRef_prefix Prefix="../../../Common/Images/" ID="SortRef1" runat="server" SortExpr="email" SortExprText="E-mail" /></div>
            </HeaderTemplate>
            <ItemTemplate>
            ...
            <HeaderTemplate>
                <div><fbs:SortRef_prefix Prefix="../../../Common/Images/" ID="SortRef2" runat="server" SortExpr="IsActive" SortExprText="Состояние" /></div>
            </HeaderTemplate>
            <ItemTemplate>
    ...
    <web:NoRecordsText runat="server" ControlId="dgAdministratorList">
    ...
    <asp:SqlDataSource runat="server" ID="dsAdministratorList" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="Administrator" Name="groupCode" Type="String" />
    ...
    <asp:SqlDataSource runat="server" ID="dsAdministratorListCount" 
        ConnectionString="<%$ ConnectionStrings:Fbs.Core.Properties.Settings.FbsConnectionString %>"
        SelectCommand="SearchAccount" CancelSelectOnNullParameter="false"
        SelectCommandType="StoredProcedure"> 
        <SelectParameters>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccountKeyList.aspx.cs" 
    Inherits="Fbs.Web.Administration.Accounts.Users.AccountKeyList"
...
<asp:Content runat="server" ContentPlaceHolderID="cphActions">
    ...
    <div class="border-block">
        ...
        <div class="content" id="JSPlaceHolder">
            <ul>
            <li><a href="/Administration/Accounts/Users/AccountKeyCreate.aspx?login=<%= Login %>" title="Создать ключ доступа">Создать ключ доступа</a></li>
            </ul>
        </div>
...
<form runat="server">
    ...
    <asp:DataGrid runat="server" id="dgAccountKeyList"
        ...
        <Columns>
            ...
            <ItemTemplate>
                <a href="/Administration/Accounts/Users/AccountKeyEdit.aspx?login=<%= Login %>&key=<%# Eval("Key") %>" title="Редактировать ключ доступа" ><%# Eval("Key") %></a>
            </ItemTemplate>
            </asp:TemplateColumn>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="List.aspx.cs" 
    Inherits="Fbs.Web.Administration.Accounts.Support.List"
...
<asp:Content runat="server" ContentPlaceHolderID="cphContent">
    ...
    <tr><td>
        ...
        <web:DataSourcePager runat="server"
            ...
            DataSourceId="dsSupportListCount"
    ...
    <asp:DataGrid runat="server" id="dgSupportList"
        DataSourceID="dsSupportList"
        ...
        <Columns>
            ...
            <ItemTemplate>
                <a href="/Administration/Accounts/SupportUsers/View.aspx?login=<%# 
    ...
    <web:NoRecordsText runat="server" ControlId="dgSupportList">
    ...
    <asp:SqlDataSource runat="server" ID="dsSupportList" 
        ...
        <SelectParameters>
            <asp:Parameter DefaultValue="Support" Name="groupCode" Type="String" />
    ...
    <asp:SqlDataSource runat="server" ID="dsSupportListCount" 
        ConnectionString="<%$ ConnectionStrings:Fbs.Core.Properties.Settings.FbsConnectionString %>"
        SelectCommand="SearchAccount" CancelSelectOnNullParameter="false"
        SelectCommandType="StoredProcedure"> 
        <SelectParameters>

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CommonNationalCertificateDenyingLoadErrors.aspx.cs" 
    Inherits="Fbs.Web.Administration.Certificates.CommonNationalCertificateDenyingLoadErrors" 
...
<asp:Content ContentPlaceHolderID="cphContent" runat="server">
    <p id="ExportContainer">
        <a href="/Administration/Certificates/CommonNationalCertificateDenyingLoadErrorsExport.aspx?id=<%= Request.QueryString["id"] %>">Экспортировать в Excel</a>
    </p>
    ...
    <asp:SqlDataSource  runat="server" ID="dsResultsList" 
        ...
        SelectCommand="dbo.SearchCommonNationalExamCertificateDenyLoadingTaskError"  CancelSelectOnNullParameter="false"

<%@ Page Language="C#" AutoEventWireup="true" 
    CodeBehind="CommonNationalCertificateDenyingLoadErrorsExport.aspx.cs" 
    Inherits="Fbs.Web.Administration.Certificates.CommonNationalCertificateDenyingLoadErrorsExport" %>
<%@ Import Namespace="Fbs.Utility" %>
<% 
    
    // Установлю хидеры страницы
    ResponseWriter.PrepareHeaders("DenyingLoadErrors.xls", "application/vnd.xls", 
          Encoding.GetEncoding(1251));

%> 
<html>
<body>
	<asp:DataGrid runat="server" DataSourceID="dsExport"
...
<asp:SqlDataSource  runat="server" ID="dsExport" 
    ...
    SelectCommand="dbo.SearchCommonNationalExamCertificateDenyLoadingTaskError"

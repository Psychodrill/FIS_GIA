...
namespace Fbs.Web.Administration.FAQ
{
    public partial class List : BasePage
    {
        ...
        {
            Fbs.Core.AskedQuestion.DeleteAskedQuestions(GetSelected());
            ProcessSuccess();
        }

        protected void btnAcivate_Click(object sender, EventArgs e)
        {
            Fbs.Core.AskedQuestion.ActivateAskedQuestions(GetSelected());
            ProcessSuccess();
        }

        protected void btnDeactivate_Click(object sender, EventArgs e)
        {
            Fbs.Core.AskedQuestion.DeactivateAskedQuestions(GetSelected());
            ProcessSuccess();
        }

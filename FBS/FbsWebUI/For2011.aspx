<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="For2011.aspx.cs" Inherits="Fbs.Web.For2011"
...
<asp:Content runat="server" ContentPlaceHolderID="cphContent">
  <div class="notice" id="CheckTitleNotice">
                        ...
                        <div class="cont">
                            ...
                            <div class="txt-in">
                                <p>
                                   В текущем году проводится подготовка ФБС к эксплуатации в защищенном режиме для
    ...
    решений по организации защищенного режима работы с ФБС <b>приглашаем принять участие
    ...
    возможность работать с ФБС в стандартном режиме. </p><p>Консультации по телефону горячей
    линии ФБС (495) 989 16 29.
    <br />
    <br /></p>
                            </div>
                        </div>
    ...
    <asp:DataGrid Width="100%" runat="server" ID="dgDocumentList" DataSourceID="dsDocumentList"
        ...
        <Columns>
            <asp:TemplateColumn>
                ...
                <HeaderTemplate>
                <div>
                         <fbs:sortref_prefix ID="Sortref_prefix1" prefix="../Common/Images/" runat="server" sortexpr="Name"

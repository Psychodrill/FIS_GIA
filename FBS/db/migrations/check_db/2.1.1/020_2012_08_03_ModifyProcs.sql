...
insert into Migrations(MigrationVersion, MigrationName) values (20, '020_2012_08_03_ModifyProcs.sql')
-- =========================================================================
GO 
	...
	#CommonNationalExamCertificateSubjectCheck a join subject b on a.SubjectCode=b.Code
	 ...
	 select @yearFrom = 2010, @yearTo = 2012
       ...
       select
        ...
        from
       (
       select a.CertificateCheckingId,b.PassportNumber,b.PassportSeria,c.SubjectId
       from 
       #CommonNationalExamCertificateCheck a join 
       CommonNationalExamCertificate b with(nolock) on  b.fio=a.CertificateNumber
       ...
       join(
        select a.CertificateCheckingId,a.PassportNumber,a.PassportSeria,b.SubjectId
       from
       ...
       ) b on a.PassportNumber=b.PassportNumber and isnull(a.PassportSeria,'''')=isnull(b.PassportSeria,'''') and a.SubjectId=b.SubjectId

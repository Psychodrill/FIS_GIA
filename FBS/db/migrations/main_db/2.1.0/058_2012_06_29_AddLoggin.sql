...
insert into Migrations(MigrationVersion, MigrationName) values (58, '058_2012_06_29_AddLoggin.sql')
-- =========================================================================
GO
...
declare 
    ...
    begin
        ...
        set @commandText = @commandText + ' and certificate.InternalPassportSeria like @internalPassportSeria '
	end

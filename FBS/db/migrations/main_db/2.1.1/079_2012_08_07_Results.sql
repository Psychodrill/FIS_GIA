...
insert into Migrations(MigrationVersion, MigrationName) values (79, '079_2012_08_07_Results.sql')
-- =========================================================================
GO
ALTER PROCEDURE [dbo].[CommonNationalExamCertificateSumCheckResult] @batchId BIGINT = 301519088383
AS 
    set nocount on

...
GO
PRINT N'Creating FK_Organization2010_Organization2010...';


GO
ALTER TABLE [dbo].[Organization2010] WITH NOCHECK
...
GO
PRINT N'Creating FK_OrganizationRequest2010_RecruitmentCampaigns...';


GO
ALTER TABLE [dbo].[OrganizationRequest2010] WITH NOCHECK
    ADD CONSTRAINT [FK_OrganizationRequest2010_RecruitmentCampaigns] FOREIGN KEY ([RCModelID]) REFERENCES [dbo].[RecruitmentCampaigns] ([Id]) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
BEGIN	
	...
	BEGIN TRAN		
		...
		BEGIN
			...
			SET RCModel = @suggestedRCModelID, RCDescription = @suggestedRCDescription
			WHERE Id = @orgID
		END
...
GO
ALTER TABLE [dbo].[GroupAccount] WITH CHECK CHECK CONSTRAINT [FK_GroupAccount_Account];

ALTER TABLE [dbo].[OrganizationRequestAccount] WITH CHECK CHECK CONSTRAINT [FK_OrganizationRequestAccount_OrganizationRequest2010];

ALTER TABLE [dbo].[Organization2010] WITH CHECK CHECK CONSTRAINT [FK_Organization2010_Organization2010];

ALTER TABLE [dbo].[OrganizationRequest2010] WITH CHECK CHECK CONSTRAINT [FK_OrganizationRequest2010_RecruitmentCampaigns];

...
insert into Migrations(MigrationVersion, MigrationName) values (31, '031_2012_06_08_tgAccountLog')
-- =========================================================================

/****** Object:  Trigger [tgAccountLog]    Script Date: 06/08/2012 18:12:43 ******/
IF  EXISTS (SELECT * FROM sys.triggers WHERE object_id = OBJECT_ID(N'[dbo].[tgAccountLog]'))
DROP TRIGGER [dbo].[tgAccountLog]
GO

/****** Object:  Trigger [dbo].[tgAccountLog]    Script Date: 06/08/2012 18:12:43 ******/
SET ANSI_NULLS ON
GO

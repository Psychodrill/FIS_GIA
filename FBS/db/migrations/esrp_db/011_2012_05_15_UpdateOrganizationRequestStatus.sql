...
insert into Migrations(MigrationVersion, MigrationName) values (11, '011_2012_05_15_UpdateOrganizationRequestStatus.sql')
-- =========================================================================

/****** Object:  StoredProcedure [dbo].[UpdateOrganizationRequestStatus]    Script Date: 05/15/2012 14:08:32 ******/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[UpdateOrganizationRequestStatus]') AND type in (N'P', N'PC'))
DROP PROCEDURE [dbo].[UpdateOrganizationRequestStatus]
GO
...
BEGIN	
	...
	BEGIN TRAN	
		...
		BEGIN
			...
			WHERE Id = @orgRequestID
			select @orgID,@suggestedRCModelID

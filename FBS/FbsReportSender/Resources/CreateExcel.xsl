                ...
                <Worksheet>
                    ...
                    <Table>
                        ...
                        <xsl:if test="@code='ReportOrgsInfoByRegionTVF'">
                            ...
                            <Column ss:Index="27" ss:AutoFitWidth="0" ss:Width="96"/>
                            <Column ss:AutoFitWidth="0" ss:Width="93.75"/>
                            <Column ss:Width="48.75" ss:Span="8"/>
                            <Column ss:Index="38" ss:AutoFitWidth="0" ss:Width="55.5"/>
                        ...
                        <xsl:if test="@code='ReportOrgsInfoTVF'">
                            ...
                            <Column ss:AutoFitWidth="0" ss:Width="110.25" ss:Span="1"/>
                            <Column ss:Index="20" ss:AutoFitWidth="0" ss:Width="76.5"/>
